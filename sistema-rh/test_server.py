...
from src.routes.beneficio import beneficio_bp
from src.routes.rescisao import rescisao_bp
...
app.register_blueprint(beneficio_bp, url_prefix='/api')
app.register_blueprint(rescisao_bp, url_prefix='/api')
